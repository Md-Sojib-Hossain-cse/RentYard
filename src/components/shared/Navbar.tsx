...
const Navbar = () => {
  ...
  return (
    <nav className="2xl:border-b 2xl:border-gray-400">
      <div className="flex justify-between items-center p-2 md:p-4 w-full max-w-5xl lg:mx-auto">
        <h1 className="flex gap-2 items-center">
          <a href="#">
            <img
              src={Logo}
              alt=""
              className="h-5 w-5 md:h-6 md:w-6 lg:h-8 lg:w-8 p-1 lg:p-2 bg-white shadow-2xl shadow-blue-400 rounded-lg"
            />
          </a>
        ...
        <div className="hidden md:flex justify-end items-center gap-4 md:gap-8 lg:gap-12 text-lg">
          ...
          <div className="space-x-2">
            <button className="px-5 py-1 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 shadow-lg font-medium text-white hover:from-[#26314b] hover:to-[#26314b] cursor-pointer transition delay-100">
              Login
            </button>
            <button className="px-5 py-1 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 shadow-lg font-medium text-white hover:from-[#26314b] hover:to-[#26314b] cursor-pointer transition delay-100">
              Sign up
